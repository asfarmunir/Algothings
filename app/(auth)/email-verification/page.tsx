              ...
              <div className="flex flex-col items-center">
                ...
                <div className="text-center py-4">
                  ...
                  />
                    ...
                    <Button
                      className="bg-gradient-to-r from-customgreen to-customblue text-black rounded-md my-2 py-[12px] text-[14px] w-full"
                      label="Verify OTP"
                      type="submit"
                    />
                    <Button
                      className="bg-[#091612] text-white border border-[#FFFFFF0F] rounded-md w-full mt-2 py-[12px] text-[14px]"
                      label="Resend OTP"
                      onClick={resendOtp}
                    />
                  </form>
