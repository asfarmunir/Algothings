...
export default function Register() {
    const { showPassword, togglePasswordVisibility, selectedCountry,
        handleSelectCountry, isChecked, handleCheckboxChange, formData, handleInputChange, handleSubmit
    } = useRegisterForm();
      ...
      <>
        ...
        <main className="px-4 md:px-10 py-5 gradient-corners h-screen lg:h-screen gradient-bg flex flex-row gap-8 ">
            ...
            <div className="w-full lg:w-3/4 md:mx-6 lg:mx-20 flex justify-center items-center lg:items-start xl:items-start overflow-y-auto scrollbar-none">
                ...
                <div className='rounded-xl bg-customcard border border-[#FFFFFF00] px-6 py-10 md:py-6'>

                    <h1 className="text-[20px] md:text-[32px] font-bold mt-8 md:mt-0 mb-5">Create an account.</h1>
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                       ...
                       <div className="flex items-start gap-2">
                            ...
                            <p className="text-[14px] leading-4 text-white">
                                ...
                                <a href="#" className="text-[#00FF7F]">Terms of Service</a>.
                                We'll occasionally send you account-related emails.
                            </p>
                        </div>

                        <Button type="submit" className='w-full py-[12px] text-[16px] bg-gradient-to-r from-customgreen to-customblue text-black rounded-md' label="Sign Up" />
                        ...
                        <p className="text-center text-[14px] text-white">
                            Have an account?{' '}
                            <a href="/login" className="text-[#00FF7F]">Log in</a>
                        </p>
