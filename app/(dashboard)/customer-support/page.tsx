          ...
          <div className="flex-grow py-6 px-10 gradient-corners-main font-gilroy">
            ...
            <div className="bg-customcard border border-[#FFFFFF33] w-full rounded-md p-5">
              <form onSubmit={handleSubmit}>
                ...
                {/* Message Textarea */}
                <div className="mb-5">
                  <label htmlFor="message" className="block mb-2 text-sm font-normal tracking-wider text-white font-gilroy">Message</label>
                  <textarea
                  id="message"
                  rows={6}
                ...
                <div className="flex flex-col md:flex-row gap-5">
                  <div className="flex items-center justify-center w-full">
                    <label htmlFor="dropzone-file" className="w-full border border-[#FFFFFF33] rounded-md cursor-pointer bg-[#FFFFFF05] py-3 px-2">
