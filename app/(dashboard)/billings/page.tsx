...
export default function BillingDetails() {
    const { formData, isSubmitting, error, handleInputChange, handleSubmit } = useBillingDetails();
                            ...
                            <div className="w-full lg:w-2/3">
                                ...
                                <div className="mt-4">
                                    <form className=" space-y-4" onSubmit={(e) => e.preventDefault()}>
                                        ...
                                        <div className="flex w-full flex-col gap-4 md:flex-row">
                                            <div className="w-full">
                                                <div className="flex flex-col">
                                                    <label className="text-sm text-white pb-2">Country</label>
                                                    <Dropdown
                                                        options={["Pakistan", "Australia", "Canada", "US", "UK"]}
                                        ...
                                        <p className="text-[12px] text-[#848BAC]">By providing your information, you allow Pickshero to charge your card for future payments in accordance with their terms.</p>


                                        <div className="flex flex-row gap-3">
                                            <Button label="BACK" className="bg-[#03100C] rounded-lg back-btn py-[10px] text-sm" />
