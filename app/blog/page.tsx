    ...
    <>
      <div className="">
        ...
        <div className="mx-4 md:mx-12 lg:mx-[100px]">
          <FadeInSection>
          <h1 className="text-[60px] leading-[60px] bg-gradient-to-r from-[#45F175] to-[#00C3CE] bg-clip-text text-transparent text-center">
          ...
          <div className="mt-8 flex justify-between">
            ...
            <div className='flex flex-row gap-4'>
              <FaFacebookF className='text-xl cursor-pointer' onClick={()=> alert('hello')} />
              <FaDiscord className='text-xl cursor-pointer' onClick={()=> alert('hello')} />
              <FaXTwitter className='text-xl cursor-pointer' onClick={()=> alert('hello')} />
              <RiInstagramFill className='text-xl cursor-pointer' onClick={()=> alert('hello')} />
            </div>
          </div>
        </div>
      </div>
