                ...
                <div className="mb-4 mt-12">
                    <FadeInSection>
                        ...
                        <h1 className='py-1 px-2 text-6 text-[44px] lexend  leading-[44px] my-3'>
                            Choose <span className='bg-gradient-to-r from-customgreen to-customblue bg-clip-text text-transparent'>Your Plan</span>
                        </h1>
                    </FadeInSection>
...
`} onClick={() => handlePlanChange("Annual")} />
                    ...
                    border p-8  border-[#FFFFFF1A] rounded-2xl text-start md:w-[400px] lg:w-[490px]`}>
                                    ...
                                    <div className='mt-6 text-start'>
                                        ...
                                        <span className={` ${activePlan === "Monthly" ? ' font-semibold text-black' : ''} text-[36px]`}>$97</span>
                                        <span className='text-sm text-customlightgray'>/per month</span>
                                    </div>
                                    <p className='text-[14px] my-4'>Ideal for: Traders beginning their automation journey</p>

                                    <Button label='Choose Plan' className={` ${activePlan === "Monthly" ? "bg-gradient-to-r from-[#00C88C] to-[#0C7C33] text-white  " : "bg-white text-black "} w-full py-[14px] text-[14px]   rounded-md`} />
                                    ...
                                    <div className='mt-4'>
                                        {Intermediate.map((items) => (
                                            <div className='flex  flex-row gap-2 items-center py-2.5' key={items}>
                                                ...
                                                <Image src="/images/p1.svg" width={20} height={10} alt='check 1' />
                            ...
                            <CardAnimation direction='right' delay={0.5}>
                                <div className={` ${activePlan === "Annual" ? '  bg-gradient-to-r from-customgreen rounded-2xl to-customblue ' : ' bg-gradient-to-b from-[#0A0A0AE5] to-[#040404] rounded-2xl '} border p-8  border-[#FFFFFF1A] text-start relative md:w-[400px] lg:w-[490px]`}>
                                   ...
                                   <p className={`${activePlan === 'Annual'?  "bg-[#04110D]": " text-black bg-white"} py-[14px] px-[20px] text-[12px] rounded-[10px]`}>Most Popular</p>
                                    ...
                                    <p className='mt-3'>
                                        <span className={`${activePlan === 'Annual' ? ' text-black' : ''} text-[36px] font-semibold`}>$697</span>
                                        <span className='text-lg text-customlightgray'>$997</span></p>
                                    <p> <span className={`${activePlan === 'Annual' ? ' text-black ' : 'text-white '} text-sm -mt-2`}>billed monthly</span></p>
                                    <p className='text-[14px] my-4'>Ideal for: Traders seeking a powerful, all-in-one portfolio</p>

                                    <Button label='Choose Plan' className={` ${activePlan === "Annual" ? "bg-gradient-to-r from-[#00C88C] to-[#0C7C33] text-white  " : "bg-white text-black "} w-full py-[14px] text-[14px] rounded-md`} />

                                    {master.map((items) => (
                                        <div className='flex flex-row gap-2 items-center py-2' key={items}>
                                            {/* <RiCheckboxCircleFill className=' bg-customlightgray text-black rounded-full' /> */}
                                            <Image src="/images/p1.svg" width={16} height={10} alt='check 1' />
