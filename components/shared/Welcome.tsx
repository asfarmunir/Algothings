        ...
        <div className="py-3 px-2" >
          ...
          >
            ...
            <p className="text-customlight  sm:px-6  md:px-20 leading-6 md:leading-7 my-7 text-sm  md:text-[16px] xl:text-[20px]">
              ...
              packed into our <br className="lg:block hidden" /> powerful algorithms,
              there’s no need for guesswork, programming, or constant <br className="lg:block hidden" /> monitoring. Just plug, play, and let our
              strategies work for you 100% hands-free.
            </p>

            {/* Email Input and Button */}
            <div className="space-y-4 sm:space-y-2 space-x-2 lg:space-x-4">
              
                <Button
                  label="Join our Discord"
                  className="bg-gradient-to-r py-3 px-4 from-customgreen to-customblue rounded-[6px] text-black  sm:w-auto"
                />
              ...
              <div className="inline-flex flex-col sm:flex-row items-center p-[1px] bg-gradient-to-r from-customgreen to-customblue bg-clip-border rounded-lg">
                <div className="inline-flex flex-row items-center bg-black rounded-lg gap-3 px-4 py-2.5">
                  ...
                  />
                  <Image src="/images/arrow.svg" width={16} height={16} alt="arrow icon" />
                </div>
              </div>
            </div>
          </motion.div>
...
{/* Who We Are Section */}
  ...
  <FadeInSection>
    ...
    <h1 className="py-6 text-[28px] sm:text-[28px] md:text-[44px] xl:text-[52px] font-semibold md:leading-[36px] sm:leading-[44px] xl:leading-[54px]">
      <span className="bg-gradient-to-r from-customgreen to-customblue bg-clip-text text-transparent">
        Meet our Company
      </span>{' '}
    ...
    <p className="sm:px-6 md:px-20 xl:px-[98px] text-center text-sm md:text-base xl:text-[18px] leading-7">
      The Algos Field (TAF) is an innovative algorithmic trading solutions
      company built on 15+ years of combined team experience in developing and
      optimizing trading strategies. Over the past 3+ years, our proven
      algorithms have consistently delivered an impressive 80%+ monthly win
      rate, helping traders achieve reliable, hands-free success. Whether you
      trade futures, stocks, crypto, indices, or commodities, our advanced
      algorithms are designed to deliver consistent performance, risk
      minimization, and wealth maximization. Our tailored solutions include 10
      individual trading algorithms for focused strategies, an all-in-one
      diversified portfolio for balanced growth, and a premium fully managed
      service for seamless account optimization. Backed by transparency,
      innovation, and continuous updates, The Algos Field empowers you to trade
      smarter, minimize risk, and stay ahead of the market, without guesswork,
      programming, or constant monitoring.
    </p>
    </FadeInSection>

    <FadeInSection>
    <div className="mt-6 mb-2 mx-4 md:mx-8 lg:mx-10 md:h-[300px] lg:h-[530px] md:px-10">
      <img
...
<FadeInSection>
  <div className="px-2 my-16 md:px-8 lg:px-24 xl:px-[98px]">
    ...
    <h1 className="py-4 text-[28px] sm:text-[32px] md:text-[44px] xl:text-[56px] lexend leading-[36px] sm:leading-[44px] xl:leading-[54px]">
      <span className="bg-gradient-to-r from-customgreen to-customblue bg-clip-text text-transparent">
        Start Your Career
      </span>{' '}
    ...
    {/* Steps plan cards */}
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-[10px] w-full py-3 px-2">
      {['Step 1', 'Step 2', 'Step 3', 'Step 4'].map((item, index) => (
        ...
        >
          <button
            ...
            className={` py-[14px] w-full rounded-md transition duration-300 uppercase ${
              activeStep === index + 1
              ...
              <div className="h-auto lg:h-[520px] flex md:flex-row flex-col-reverse justify-between bg-gradient-to-b from-[#45F175B2] via-[#00C3CEB2] to-[#020907B2] px-3 md:px-6 py-5 md:py-10 rounded-[50px] text-black">
                ...
                <div className="w-full flex flex-col justify-center px-2 md:px-6 lexend">
                  <div className='text-start leading-[28px]'>
                    <h1 className="font-semibold leading-10 text-[32px] pt-2">{stepContent[activeStep - 1].title}</h1>
                    <p className="text-[16px] py-2">
                      {stepContent[activeStep - 1].description}
                    </p>
                    <ul className="space-y-1 list-disc pl-5 text-[16px]">
                      {stepContent[activeStep - 1].points?.map((point, index) => (
                        <li className='' key={index}>{point}</li>
                      ))}
                    </ul>

                    <p className='text-sm py-2'>{stepContent[activeStep - 1].endDescription}</p>

                    <div className='mt-4 '>
                      <Button label={stepContent[activeStep - 1].btntitle} className='bg-gradient-to-r text-sm from-customgreen to-customblue py-[16px] px-[36px] rounded-[8px]' />
                    </div>
                  </div>
                </div>
