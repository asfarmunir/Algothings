                ...
                <div key={index} className="group border-none mb-4">
                    ...
                    <AnimationSection>
                        <div
                            ...
                            className="bg-[#04100C] tracking-wider px-[20px] py-[10px] text-[18px] font-semibold rounded-md border border-[#FFFFFF33] flex justify-between items-center cursor-pointer"
                        >
